...
(* top =  1  *)
(* src = "uart.v:2.1-78.10" *)
module uart(clk, rst, tx_start, tx_data, tx, tx_busy, rx, rx_data, rx_valid);
  (* src = "uart.v:6.16-6.19" *)
  input clk;
  wire clk;
  (* src = "uart.v:7.16-7.19" *)
  input rst;
  wire rst;
  (* src = "uart.v:8.16-8.24" *)
  input tx_start;
  wire tx_start;
  (* src = "uart.v:9.22-9.29" *)
  input [7:0] tx_data;
  wire [7:0] tx_data;
  (* src = "uart.v:10.16-10.18" *)
  output tx;
  wire tx;
  (* src = "uart.v:11.16-11.23" *)
  output tx_busy;
  wire tx_busy;
  (* src = "uart.v:13.16-13.18" *)
  input rx;
  wire rx;
  (* src = "uart.v:14.22-14.29" *)
  output [7:0] rx_data;
  wire [7:0] rx_data;
  (* src = "uart.v:15.16-15.24" *)
  output rx_valid;
  wire rx_valid;
  (* src = "uart.v:22.1-26.4" *)
  wire [15:0] _000_;
  (* src = "uart.v:22.1-26.4" *)
  wire _001_;
  (* src = "uart.v:57.1-76.4" *)
  wire _002_;
  wire _003_;
  wire _004_;
  wire _005_;
  ...
  (* src = "uart.v:67.9-67.29" *)
  wire _155_;
  (* src = "uart.v:19.12-19.20" *)
  wire [15:0] baud_cnt;
  (* src = "uart.v:20.5-20.14" *)
  wire baud_tick;
  (* src = "uart.v:53.11-53.17" *)
  wire [2:0] rx_bit;
  (* src = "uart.v:55.5-55.12" *)
  wire rx_busy;
  (* src = "uart.v:54.11-54.19" *)
  wire [7:0] rx_shift;
  (* src = "uart.v:30.11-30.17" *)
  wire [3:0] tx_bit;
  ...
  sky130_fd_sc_hd__o211ai_1 _196_ (
    .A1(rx_busy),
    .A2(rx),
    .B1(_097_),
    .C1(rx_bit[0]),
  ...
  sky130_fd_sc_hd__o211ai_1 _198_ (
    .A1(rx_busy),
    .A2(rx),
    .B1(_097_),
    .C1(rx_bit[1]),
  ...
  sky130_fd_sc_hd__a22oi_1 _212_ (
    .A1(tx_shift[5]),
    .A2(_081_),
    .B1(_082_),
    .B2(tx_data[3]),
  ...
  sky130_fd_sc_hd__nand4_1 _227_ (
    .A(baud_cnt[1]),
    .B(baud_cnt[0]),
    .C(baud_cnt[3]),
    .D(baud_cnt[2]),
  ...
  sky130_fd_sc_hd__nor4b_1 _249_ (
    .A(baud_cnt[3]),
    .B(baud_cnt[10]),
    .C(baud_cnt[12]),
    .D_N(baud_cnt[8]),
  ...
  (* src = "uart.v:32.1-50.4" *)
  sky130_fd_sc_hd__dfstp_2 _352_ (
    .CLK(clk),
    .D(_076_),
    .Q(tx),
    .SET_B(_048_)
  ...
  (* src = "uart.v:32.1-50.4" *)
  sky130_fd_sc_hd__dfstp_2 _353_ (
    .CLK(clk),
    .D(_058_),
    .Q(tx_shift[0]),
    .SET_B(_027_)
  ...
  (* src = "uart.v:32.1-50.4" *)
  sky130_fd_sc_hd__dfstp_2 _354_ (
    .CLK(clk),
    .D(_057_),
    .Q(tx_shift[1]),
    .SET_B(_026_)
  ...
  (* src = "uart.v:32.1-50.4" *)
  sky130_fd_sc_hd__dfstp_2 _358_ (
    .CLK(clk),
    .D(_053_),
    .Q(tx_shift[5]),
    .SET_B(_022_)
  ...
  (* src = "uart.v:32.1-50.4" *)
  sky130_fd_sc_hd__dfstp_2 _360_ (
    .CLK(clk),
    .D(_051_),
    .Q(tx_shift[7]),
    .SET_B(_020_)
  ...
  (* src = "uart.v:32.1-50.4" *)
  sky130_fd_sc_hd__dfstp_2 _362_ (
    .CLK(clk),
    .D(_077_),
    .Q(tx_shift[9]),
    .SET_B(_049_)
